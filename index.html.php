...
<body>
	...
	<header>
		<div class="screen" id="aboutme">
			<div class="content">
				<h1>Nick Long <small>Examples of work</small></h1>
	...
	<div class="screen" id="peanuts">
		<div class="content">
			<div class="text">
				<h2>Peanuts</h2>
				<p>A proof of concept for a different kind of web comic.</p>
				<p>I’m currently collaborating with the artist <a href="https://www.facebook.com/moderndaycrisis" title="CRISIS on facebook">CRISIS</a> to create a series of web comics.</p>
				<p>Peanuts is just a taste of what is possible.</p>
	...
	<div class="screen" id="results">
		<div class="content">
			<div class="text">
				...
				<p>Interning for Learnosity I given the opportunity to implement a new design.</p>
				<p>In this section I built the layout using the twitter bootstraps framework,  produced the donut chart with canvas and javascript and used JQuery and CSS3 for the interactive elements.</p>
			</div>
	...
	<div class="screen" id="nicklosh">
		<div class="content">
			<div class="text">
				<h2>nicklósh</h2>
				<p>I designed and built this site for my alter ego, nicklósh is the storyteller I produce music and videos as a hobby/ in my spare time</p>
				<p>I developed this site using the Compass and jquery libraries. It’s actually a single page site so load time is fast and I used ajax for the video sections. </p>
				<p>I’m currently redesigning the site so watch this space</p>
	...
	<div class="screen" id="ameb">
		<div class="content">
			<div class="text">
				...
				<p>The enrolment process was stressful for the users, the users are typically older and less computer literate.</p>
				<p>My aim was to make this process more relaxing by adding a calming colour pallette, making the interaction easier by making a clear definition between the controls and the results</p>
				<p>I improved the look and feel of this site adding ameb branding and responsive design.</p>
				<p>My role was, improve visual design to existing layout. Implementation of improved design</p>
			</div>
	...
	<div class="screen" id="syllabus">
		<div class="content">
			<div class="text">
				<h2>NSW Syllabus</h2>
				<p>For the Australian Curriculum, I was selected to be part of team dedicated to producing this new web site</p>
				<p>My role was to implement the design. I also contributed in the design and development of the search, filter and download sections.</p>
	...
	<div class="screen" id="builder">
		<div class="content">
			<div class="text">
				...
				<p>Web application for the Board of Studies NSW.</p>
				<p>The sister app to the NSW Syllabus, on this app registered users can build their own teaching programs drawing directly from the syllabuses published on the NSW Syllabus site. </p>
				<p>The site was developed using twitter bootstraps. I provided additional design and development to improve usability</p>
